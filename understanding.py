...
class ListFrame(ttk.Frame):
    def __init__(self,parent,text_data,item_height):
        ...
        self.canvas.create_window((0,0),window=self.frame ,anchor="nw",width=200,height=self.list_height)
        
        #events
        self.canvas.bind_all('<MouseWheel>',lambda event:self.canvas.yview_scroll(-int(event.delta/60) ,"unit"))
        self.bind('<Configure>',self.upadate_size)
        
    def upadate_size(self,event):
        ...
        self.canvas.create_window((0,0),window=self.frame ,anchor="nw",width=self.winfo_width(),height=self.list_height)
...
text_list=[('label','button'),('thing','something'),('label1','button'),('label2','button2'),('label','button'),('thing','something'),('label1','button'),('label2','button2')]
